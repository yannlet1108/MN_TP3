                       ...
                       const void *Y, const int incY, void *dotu)
{
  ...
  for (; ((i < N) && (j < N)) ; i += incX, j+=incY)
    {
      result=add_complexe_double(result,mult_complexe_double(((complexe_double_t*)X)[i],((complexe_double_t*)Y)[j])) ;
    }
  
  *((complexe_double_t*)dotu)=result;
  return ;
}
                       ...
                       const void *Y, const int incY, void *dotc)
{
  ...
  for (; ((i < N) && (j < N)) ; i += incX, j+=incY)
    {
      result=add_complexe_double(result,mult_complexe_double(((complexe_double_t*)X)[i],conjugue_double(((complexe_double_t*)Y)[j]))) ;
    }
  
  *((complexe_double_t*)dotc)=result;
  return ;
}
